...
@Component({
  selector: 'app-terms-privacy-page',
  imports: [Breadcrumbs, HtmlContent],
  template: `
    <article class="wrap" aria-labelledby="terms-privacy-page-title">
      <app-breadcrumbs [items]="breadcrumbs" />
      <h1 id="terms-privacy-page-title">{{ page.title }}</h1>
      <app-html-content [html]="page.html" />
    </article>
  `,
})
export class TermsPrivacyPage {
  protected readonly page = PAGE_CONTENT.termsPrivacy;
