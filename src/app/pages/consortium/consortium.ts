...
@Component({
  selector: 'app-consortium-page',
  imports: [Breadcrumbs, HtmlContent],
  template: `
    <section class="wrap" aria-labelledby="consortium-page-title">
      <app-breadcrumbs [items]="breadcrumbs" />
      <h1 id="consortium-page-title">{{ page.title }}</h1>
      <app-html-content [html]="page.html" />
    </section>
  `,
})
export class ConsortiumPage {
  protected readonly page = PAGE_CONTENT.consortium;
  protected readonly breadcrumbs: BreadcrumbContent[] = [
    { label: 'Home', targetPageId: 'page-root', sourceHref: '/' },
    { label: 'Κοινοπραξία', targetPageId: null, sourceHref: null },
  ];
