...
@Component({
  ...
  template: `
    <article class="wrap" aria-labelledby="objectives-page-title">
      <app-breadcrumbs [items]="breadcrumbs" />
      <h1 id="objectives-page-title">{{ page.title }}</h1>
      <app-html-content [html]="page.html" />
    </article>
  `,
})
export class ObjectivesPage {
  protected readonly page = PAGE_CONTENT.objectives;
  protected readonly breadcrumbs: BreadcrumbContent[] = [
    ...
    { label: 'Στόχοι', targetPageId: null, sourceHref: null },
  ];
