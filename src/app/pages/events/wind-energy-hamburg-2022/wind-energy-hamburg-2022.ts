...
@Component({
  selector: 'app-wind-energy-hamburg-2022-page',
  imports: [Breadcrumbs, HtmlContent],
  template: `
    <article class="wrap" aria-labelledby="wind-energy-hamburg-2022-page-title">
      <app-breadcrumbs [items]="breadcrumbs" />
      <h1 id="wind-energy-hamburg-2022-page-title">{{ page.title }}</h1>
      <app-html-content [html]="page.html" />
    </article>
  `,
})
export class WindEnergyHamburg2022Page {
  protected readonly page = PAGE_CONTENT.windEnergyHamburg2022;
