...
@Component({
  selector: 'app-global-wind-day-2022-page',
  imports: [Breadcrumbs, HtmlContent],
  template: `
    <article class="wrap" aria-labelledby="global-wind-day-2022-page-title">
      <app-breadcrumbs [items]="breadcrumbs" />
      <h1 id="global-wind-day-2022-page-title">{{ page.title }}</h1>
      <app-html-content [html]="page.html" />
    </article>
  `,
})
export class GlobalWindDay2022Page {
  protected readonly page = PAGE_CONTENT.globalWindDay2022;
