...
@Component({
  ...
  template: `
    <article class="wrap" aria-labelledby="closing-event-page-title">
      <app-breadcrumbs [items]="breadcrumbs" />
      <h1 id="closing-event-page-title">{{ page.title }}</h1>
      <app-html-content [html]="page.html" />
    </article>
  `,
})
export class ClosingEventPage {
  protected readonly page = PAGE_CONTENT.closingEvent;
